...
use crate::cryptography::elliptic::{CurveAlgorithms, EcAlgorithms};
use crate::cryptography::rsa::RsaAlgorithms;
...
pub struct JwtManager {
    pub access_keys: JwtKeyPair,
    pub refresh_keys: JwtKeyPair,
}
...
impl JwtManager {
    ...
    fn load_rsa_keys(
        ...
        public_path: &str,
        algorithm: Algorithm,
    ) -> Result<JwtKeyPair, Box<dyn std::error::Error>> {
    ...
    fn parse_algorithm(
        ...
        match alg {
            ...
            _ => Err(format!("Unsupported algorithm: {}", alg).into()),
        }
    }
}
